...
활성화되면 Photoshop CC에서 **{% include product %} Adobe 패널**을 사용할 수 있게 됩니다. {% include product %} 컨텍스트에 대한 정보와 현재 해당 컨텍스트에 설치된 앱에 등록된 명령을 표시합니다.

![엔진](../images/engines/photoshopcc-photoshopcc_extension.png)
...
![구성요소](../images/engines/photoshopcc-extension_components.png)
...
![메뉴](../images/engines/photoshopcc-extensions_menu.png)
...
![헤더](../images/engines/photoshopcc-extension_header.png)
...
![쉘프](../images/engines/photoshopcc-extension_shelf.png)
...
![명령](../images/engines/photoshopcc-extension_commands.png)
...
![상황에 맞는 메뉴](../images/engines/photoshopcc-extension_context_menu.png)
...
![콘솔](../images/engines/photoshopcc-extension_console.png)
