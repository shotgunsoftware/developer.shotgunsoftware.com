...
- [ShotGrid 유틸리티 프레임워크](https://developer.shotgunsoftware.com/tk-framework-shotgunutils/)
...
- [ShotGrid 업로드](https://developer.shotgunsoftware.com/tk-core/descriptor.html#pointing-at-a-file-attachment-in-shotgun)
