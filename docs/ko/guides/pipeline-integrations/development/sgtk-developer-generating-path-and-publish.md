...
템플릿은 [프로젝트의 파이프라인 구성](https://developer.shotgridsoftware.com/82ff76f7/#part-2---configuring-file-system-templates)을 통해 커스터마이즈할 수 있으며 템플릿의 목적은 파일이 저장된 위치에서 작업하기 위한 표준화된 방법을 제공하는 것입니다.
...
또한 [Publish 앱](https://developer.shotgridsoftware.com/bc718491/)이 [자체 API](https://developer.shotgridsoftware.com/tk-multi-publish2/)와 함께 제공된다는 점도 주목할 만합니다.
