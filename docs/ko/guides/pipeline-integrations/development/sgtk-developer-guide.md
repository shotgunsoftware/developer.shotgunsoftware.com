...
[2세대 후크 형식에 대한 자세한 정보는 여기를 참조하십시오.](https://developer.shotgridsoftware.com/6d10dedf/)
...
Publish 앱을 사용하는 자세한 방법은 [사용자 안내서](https://developer.shotgridsoftware.com/d587be80/#the-publisher)를 참조하십시오.
