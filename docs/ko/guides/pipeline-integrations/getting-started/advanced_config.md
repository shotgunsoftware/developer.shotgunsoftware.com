...
2. {% include product %} 데스크톱. 데스크톱이 설치되어 있지 않은 경우 [이 링크를 따라 시작할 수 있습니다.](https://developer.shotgridsoftware.com/ko/d587be80/#installation-of-desktop)
...
* 사용자의 소프트웨어 응용프로그램에서 바로 {% include product %} 및 파이프라인 기능과 상호 작용할 수 있게 해 주는, 지원되는 모든 [소프트웨어 통합](https://developer.shotgridsoftware.com/ko/162eaa4b/)
...
구성을 복제하는 방법과 구성 관리에 대한 기타 기본 사항을 알아보려면 [구성 스테이징 및 롤아웃 문서](https://developer.shotgridsoftware.com/ko/60762324/#cloning-your-configuration)를 참조하십시오.
