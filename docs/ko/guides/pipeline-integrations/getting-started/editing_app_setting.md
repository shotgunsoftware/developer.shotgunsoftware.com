...
* 호출되는 설정. 이 부분은 앱의 참조 상자 또는 [앱 및 엔진 페이지](https://developer.shotgridsoftware.com/162eaa4b/)에서 확인할 수 있습니다.
