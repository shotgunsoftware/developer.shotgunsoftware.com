...
{% include figure src="../../../images/toolkit/learning-resources/tutorial/wizard_01.png" caption="**Shotgun 기본값**(Shotgun Default) 구성 유형을 선택합니다." %}

{% include figure src="../../../images/toolkit/learning-resources/tutorial/wizard_02.png" caption="**기본값 구성**(Default configuration)을 선택합니다." %}

이번에 처음으로 Shotgun 프로젝트를 설정하는 경우 프로젝트 데이터의 저장소 위치를 정의하라는 메시지가 표시될 수도 있습니다.  아니면 기존 저장소 위치를 선택할 수 있습니다.

{% include figure src="../../../images/toolkit/learning-resources/tutorial/wizard_03.png" caption="새 저장소를 만듭니다." %} %}

{% include figure src="../../../images/toolkit/learning-resources/tutorial/wizard_04.png" caption="새 저장소 이름을 지정합니다.  이 저장소는 사이트 전체 수준의 저장소이며 프로젝트별 저장소가 아닙니다." %}

{% include figure src="../../../images/toolkit/learning-resources/tutorial/wizard_05.png" caption="사용할 운영 체제에서 이 저장소에 액세스할 수 있는 경로를 설정합니다." %}
...
{% include figure src="../../../images/toolkit/learning-resources/tutorial/wizard_06.png" caption="프로젝트의 파일을 저장할 폴더 이름을 입력합니다." %}
...
{% include figure src="../../../images/toolkit/learning-resources/tutorial/wizard_07.png" caption="현재 운영 체제에 대해 선택하는 구성 경로를 기록합니다." %}
