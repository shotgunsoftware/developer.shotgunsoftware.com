...
{% include info title="Warning" content="**This topic is only valid when using ShotGrid Desktop version 1.7.3**—these steps are no longer needed when using newer versions of ShotGrid Desktop. Python 2 was removed January 26, 2023 with the release of {% include product %} Desktop 1.8.0 due to security reasons. [Learn more here](https://community.shotgridsoftware.com/t/important-notice-upcoming-removal-of-python-2-7-and-3-7-interpreter-in-shotgrid-desktop/15166)." %}
