...
![alt text](./getting_started/1_config_comparison.png "Configuration comparison chart")
...
![alt text](./getting_started/2_new_project.png "New project")

**Step 2:** Launch the Shotgun Desktop app and log in using the same username and password from your Shotgun site.

![alt text](./getting_started/3_login.png "Login")

![alt text](./getting_started/4_load_project.png "Load project")
...
![alt text](./getting_started/5_refresh_projects_list.png "Refresh project")
...
![alt text](./getting_started/6_advanced_project_setup.png "Advanced project setup")
...
![alt text](./getting_started/7_select_config.png "Select config")
...
![alt text](./getting_started/8_select_config.png "Select config")
...
![alt text](./getting_started/9_define_storage1.png "Define storage")
...
![alt text](./getting_started/10_define_storage2.png "Define storage")
...
![alt text](./getting_started/11_storage_root_folder.png "Storage root folder")
...
![alt text](./getting_started/12_define_Storage3.png "Define storage")

**Step 9:** Select save to identify the projects folder as the storage destination for project data.

![alt text](./getting_started/13_define_storage4.png "Define storage")
...
![alt text](./getting_started/14_project_folder_name_old.png "Project folder")
...
![alt text](./getting_started/15_centralized_storage.png "Centralized storage")
...
![alt text](./getting_started/16_project_setup_config.png "Project setup")
...
![alt text](./getting_started/17_project_setup_complete.png "Setup complete")
...
![alt text](./getting_started/18_config.png "Config")
