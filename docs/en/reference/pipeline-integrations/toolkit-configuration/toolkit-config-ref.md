...
To mitigate the last two issues, Toolkit configurations support _includes_.

### Includes

_Includes_ allow you to reference a section of one file in another file in your configuration. Using includes allows you set a configuration setting in one place, but use it in multiple environments.
