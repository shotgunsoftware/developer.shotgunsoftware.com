...
3.  Consider creating a [read-only permission group for API users](topicid=SG_Developer_dv_getting_started_dv_api_permissions_html) . Many scripts only need read access and this can limit your exposure to accidental changes.
