...
You should now be able to access local file linking and launch Toolkit applications from your {% include product %} site. If you are still experiencing issues after adding the exception, please visit our [support site](https://support.shotgunsoftware.com) for help.
...
If this is not the screen you are getting, please visit our [support site](https://support.shotgunsoftware.com) for help.