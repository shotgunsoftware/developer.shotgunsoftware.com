...
{% include figure src="../../images/tk_pipeline_tutorial/image_1.png" caption="Teapot and Table Assets" %}

{% include figure src="../../images/tk_pipeline_tutorial/image_2.png" caption="Shot linked to a Sequence" %}

{% include figure src="../../images/tk_pipeline_tutorial/image_3.png" caption="Tasks" width="400px" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_4.png" caption="The default Software entities defined in Shotgun" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_5.png" caption="Select the **Advanced project setup…** in the Desktop popup menu" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_9.png" caption="Make a note of the configuration path you select for the current operating system." %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_10.png" caption="The Pipeline Configuration entity in Shotgun" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_11.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_12.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_13.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_14.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_15.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_16.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_17.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_18.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_19.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_20.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_21.png" width="450px" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_22.png" %} 
...
{% include figure src="../../images/tk_pipeline_tutorial/image_23.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_24.png" %}

Next, add a simple procedural shader to the teapot. 

{% include figure src="../../images/tk_pipeline_tutorial/image_25.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_26.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_27.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_28.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_29.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_30.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_31.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_32.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_33.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_34.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_35.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_36.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_37.png" width="400px" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_40.png" width="400px" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_41.gif" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_42.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_43.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_44.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_45.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_46.png" %} 
...
{% include figure src="../../images/tk_pipeline_tutorial/image_47.png" width="400px" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_48.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_49.gif" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_50.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_51.png" %} 
...
{% include figure src="../../images/tk_pipeline_tutorial/image_52.png" %} 
...
{% include figure src="../../images/tk_pipeline_tutorial/image_53.png" %}

Now add some lights to your scene (keep it simple).

{% include figure src="../../images/tk_pipeline_tutorial/image_54.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_55.png" %}

Go ahead and publish the session and the rendered image file sequence. You should see something like this in Shotgun:

{% include figure src="../../images/tk_pipeline_tutorial/image_56.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_57.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_58.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_59.png" width="400px" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_60.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_61.png" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_62.png" width="400px" %}
...
{% include figure src="../../images/tk_pipeline_tutorial/image_63.png" %}

Check the media tab in Shotgun to see both of the uploaded quicktimes. 

{% include figure src="../../images/tk_pipeline_tutorial/image_64.png" %}
