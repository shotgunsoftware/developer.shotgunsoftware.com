...
# SSLError: [Errno 8] _ssl.c:504: 违反协议时发生 EOF

## 用例

从 Desktop 打开 Nuke 10.5 时，会出现以下 SSL 错误：
...
Nuke 版本 11 或 12 不会发生这种情况。

## 如何修复

您之所以看到此问题，是因为 Nuke 10.x 与 TLS 1.2 不兼容。该软件需要与 TLS 兼容。

## 相关链接

[在社区中查看完整主题](https://community.shotgridsoftware.com/t/sslerror-in-nuke-10-5/9299)