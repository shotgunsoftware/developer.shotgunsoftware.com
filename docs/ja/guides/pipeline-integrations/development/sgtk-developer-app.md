...
Maya などのソフトウェア内でアプリをテストする場合に、設定に 1 つまたは複数の開発項目を追加するとすぐに、Toolkit は {% include product %} メニューに**[再ロードして再起動] (Reload and Restart)**オプションを追加します。![{% include product %} メニューの再ロードして再起動オプション](./images/reload-restart.png)
