...
8. Maya の有効なサブスクリプション。[Maya の 30 日間無償体験版](https://www.autodesk.co.jp/products/maya/free-trial)を入手してください。
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/1_site_preferences.png)
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/2_custom_entity.png)
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/4_enable_entity.png)

これによって、カスタム エンティティが Shotgun でアクティブになり、表示名が *Set* になります。エンティティのシステム名は `CustomEntity01` のままなので、基本的にここではカスタム エンティティの別名を作成していることになります。この例では、`CustomEntity01` を使用していますが、別のカスタム エンティティを使用することもできます。
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/5_manage_asset_fields.png)

このアクションはアセット フィールド管理者を表示します。

![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/6_manage_asset_fields.png)
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/7_field_parameters.png)

このガイドでは、**[現在のプロジェクトのみ](Only the current project)**に適用し、**[フィールドを作成](Create Field)**を選択します。

Shotgun は新しいフィールドを設定します。

![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/8_only_current_project.png)
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/11_create_set.png)

**[「Dining Room」を作成]**を選択します。

![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/12_dining_room_set.png)
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/13_dining_room_associated.png)
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/15_file_structure.png)
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/16_custom_entity_folder.png)
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/17_schema.png)
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/folders_done.png)
...
**手順:** `maya_asset_work`テンプレート定義を次のように変更します。
...
![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/23_test_file_creation.png)

Maya で、**[Shotgun] > [File Open](ファイルを開く)**に移動し、表示されるダイアログで、Shotgun で Set を指定したアセットのタスクを選択します。

![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/24_test_new_file.png)

**[+ 新しいファイル](+New File)**を選択します。

単純な 3D オブジェクトを作成するか、**[Shotgun] > [Save File](ファイルを保存)**を使用してファイルを保存することができます。

![Python アプリ](../../../../images/toolkit/learning-resources/guides/dynamic_filesystem_configuration/file_save.png)
